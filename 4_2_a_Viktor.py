...
def plot_grid_size_vs_iterations(grid_sizes, tolerance=0.01):
    ...
    for grid_size in grid_sizes:
        ...
        _, iterations = gauss_seidel_until_converged(v, grid_size, tolerance)
        iterations_list.append(iterations)
    
    # Plot grid size vs iterations
    plt.figure(figsize=(8, 6))
    plt.plot(grid_sizes, iterations_list, marker='o')
    plt.title('Grid Size vs Number of Iterations (Gauss-Seidel)')
